...
```
行内式 [博客](https://bd-s.vercel.app "我的个人博客") 链接，带 title。
...
```html
<p>行内式 <a href="https://bd-s.vercel.app" title="我的个人博客">博客</a> 链接，带 title。</p>

<p>行内式 <a href="https://github.com/mzlogin">GitHub</a> 链接。</p>

<p>引用式 <a href="https://bd-s.vercel.app">博客</a> 链接。</p>
...
```
![Alt text](https://bd-s.vercel.app/favicon.ico "favicon")
```
...
```html
<img src="https://bd-s.vercel.app/favicon.ico" alt="Alt text" title="favicon">
```
...
我维护的工具地址：<https://md.bd-s.vercel.app>
...
另外可以参考我以前的一篇博客 [关于 Markdown 的一些奇技淫巧](https://bd-s.vercel.app/2017/09/01/markdown-odd-skills/)。
...
* [关于 Markdown 的一些奇技淫巧](https://bd-s.vercel.app/2017/09/01/markdown-odd-skills/)

---

欢迎关注我的微信公众号，接收 markdown-intro 最新动态。

<div align="center"><img width="192px" height="192px" src="https://bd-s.vercel.app/assets/images/qrcode.jpg"/></div>
